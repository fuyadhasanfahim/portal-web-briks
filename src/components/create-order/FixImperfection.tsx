...
interface FixImperfectionProps {
    setAddOns: (updater: (prev: AddOn[]) => AddOn[]) => void;
}

export default function FixImperfection({ setAddOns }: FixImperfectionProps) {
                ...
                <div className="p-6 space-y-6">
                    ...
                    >
                        <div className="space-y-4">
                            {fixImperfectionData.map((option) => (
                                <div
                                    key={option.value}
